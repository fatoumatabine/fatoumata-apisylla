...
return [
    ...
    'defaults' => [
        ...
        'paths' => [
             ...
             */
            'base' => env('L5_SWAGGER_BASE_PATH', 'https://fatoumata-apisylla-1.onrender.com/'),
        ...
        */
         ...
         */
        'constants' => [
            'L5_SWAGGER_CONST_HOST' => env('L5_SWAGGER_CONST_HOST', 'https://fatoumata-apisylla-1.onrender.com/'),
        ],
    ],
];
